    ...
    <main className="min-h-screen bg-[#050505] px-6 pt-32 pb-24 text-white md:px-12">
      <section className="mx-auto max-w-6xl">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-white/65">
            A 24-hour hackathon where students from across the state come together to ideate, build, and present innovative solutions. The event features workshops, mentorship sessions, and a final pitch competition with exciting prizes.
        </p>
        ...
        <section className="mt-20 grid gap-12 md:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="space-y-6 text-lg leading-9 text-white/65">
            <p>
              Write the full description of Hackathon here. Explain what the
