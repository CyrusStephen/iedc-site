...
>
  ...
  <img
    src="/images/get-involved/volunteer.jpeg"
      ...
      Volunteer With Us
        ...
        <section className="px-8 pt-12 pb-20 md:px-16">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.82fr] xl:gap-10">
            <div>
              <h1 className="text-4xl md:text-6xl font-semibold">Help shape the IEDC experience.</h1>
              <p className="mt-6 text-lg text-[var(--muted)]">
                Volunteer with IEDC and contribute to events, design, coordination, documentation, media, outreach, and the overall student innovation experience.
  ...
  <video
    src="/videos/get-involved/volunteer.mp4"
    autoPlay
    muted
    loop
    playsInline
