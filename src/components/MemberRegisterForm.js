...
export default function MemberRegisterForm({ onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error) {
        if (error.code === "23505") {
          throw new Error("This email is already registered for the membership campaign.");
        }
        throw error;
      }
        ...
        <AnimatePresence mode="wait">
          {!submitSuccess ? (
            ...
            >
              <div>
                ...
                <h2 className="mt-1.5 text-2xl font-semibold text-white md:text-3xl">
                  IEDC SB Membership Campaign
                </h2>
                <p className="mt-2 text-sm text-white/50">
                  Fill in your details below to become a member of the Innovation & Entrepreneurship Development Cell.
                </p>
              </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="e.g., Design, Coding, Video Editing"
                      className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white outline-none transition focus:border-[var(--accent)] focus:bg-white/[0.05]"
                    />
                  </div>
                </div>
            ...
            >
              ...
              <h2 className="mt-6 text-2xl font-semibold text-white">Application Submitted!</h2>
              <p className="mt-3 max-w-sm text-sm text-white/50 leading-relaxed">
                Thank you for applying to join IEDC SB College. We have successfully registered your application, and we'll reach out to you soon.
              </p>
